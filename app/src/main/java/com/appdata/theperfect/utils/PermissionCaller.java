...
public class PermissionCaller {
    ...
    public Boolean isAccessLocation(int fineReq) {
        boolean isFine = ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED;
    ...
    public void reqAccessLocation(int fineReq) {
        ActivityCompat.requestPermissions(context, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, fineReq);
    }
